---
layout: post
title: "Ruminations on the AI Supervisor: From Writing Code to Auditing Intelligence"
date: 2026-03-09T13:23:10+01:00
author: jcramos
comments: true
tags: ["software","ai"]
categories: ["ai"]
...
I recently had a conversation with a colleague that highlighted the widening "perception gap" in our industry. There is a distinct divide between engineers who experimented with LLMs six months ago and those integrating the latest frontier models into their daily workflows.
...
Better AI is coming, whether we feel "ready" or not. There is no point in becoming a modern-day Luddite, trying to break the looms to save the weaving trade. Resistance to the tool only guarantees you'll be the one left behind by the workflow.
In many ways, this is actually an exciting time to be a developer. We are being handed a leverage multiplier unlike anything seen in history. We can build bigger, faster, and more complex systems than a single human could have dreamt of a decade ago.

### The Painful Path Forward
If AI eventually "takes all the jobs," it could be a net positive for society in the long run—provided it is managed properly. Decoupling survival from labor is a noble goal, but the adaptation will be painful. We are currently in that uncomfortable "middle" phase where our economic structures haven't caught up to our technological capabilities.
The goal for us now isn't to out-code the AI. It's to embrace the change and become the most capable supervisors of the intelligence we’ve helped create.
